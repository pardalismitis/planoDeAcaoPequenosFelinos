# Plano de Ação Nacional para Conservação dos Pequenos Felinos (PAN Pequenos Felinos) - Ação 6.1.

Repositório dedicado à organização, análise, monitoramento e disseminação de dados e produtos relacionados a Ação 6.1. do **2º Ciclo do Plano de Ação Nacional para Conservação dos Pequenos Felinos** [(PAN Pequenos Felinos)](https://www.gov.br/icmbio/pt-br/assuntos/biodiversidade/pan/pan-pequenos-felinos), coordenado pelo **ICMBio**.
...
├── planoDeAcaoPequenosFelinos.Rproj  ← Arquivo de projeto para R Studio
│
