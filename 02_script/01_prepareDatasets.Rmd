...
```{r}
# export data
readr::write_csv(ca_occ, "../01_input/atlantic_camtrap.csv")
```
...
```{r}
# export data
readr::write_csv(lm_occ, "../01_input/atlantic_large_mammals.csv")
```
...
```{r}
# export data
readr::write_csv(neo_car_occ, "../01_input/neotropical_carnivores.csv")
